...
public class questionsAboutImportantThingsTests extends BaseTest {

    private final String question;
    private final String expected;

    public questionsAboutImportantThingsTests(String question, String expected) {
        this.question = question;
        this.expected = expected;
    }

    @Parameterized.Parameters
    public static Object[][] getQuestionsList() {
        return new Object[][]{
    ...
    // Тестовый метод
    @Test
    public void testToggleQuestionAndAnswer() {
